...
var rollbar = new Rollbar({
  accessToken: 'e83d56c11f904db4a7e5c351d90e4fc2',
...
app.get('/api/robots', (req, res) => {
    rollbar.info("Robots reporting for duty")
    try {
...
app.get('/api/robots/five', (req, res) => {
    rollbar.info("We are the chosen ones")
    try {
...
app.post('/api/duel', (req, res) => {
    rollbar.info("TIME TO Da Da Da Da  DUEL!")
    try {
...
app.get('/api/player', (req, res) => {
    rollbar.info("Yo here's your stats")
    try {
